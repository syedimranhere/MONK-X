        ...
        <div className="min-h-screen w-full relative">
            ...
            `}
                        >
                            ...
                            <span>{loadingCredentials ? "Creating account..." : "Sign Up"}</span>
                        </button>
                    </form>
                    <p className="text-center  text-neutral-300 mb-2 text-xs mt-6 ">
                        By signing in, you agree to our{" "}
                        <a href="#" className="text-green-700no-underline hover:underline ">
                            Terms
                        </a>{" "}
                        and{" "}
                    ...
                    <div className="flex justify-center text-center gap-1">
                        ...
                        <a href="/" className="text-green-700  text-xs hover:underline ">Sign in</a>
                    </div>
