...
export default function Sidebar() {
    ...
    return (
        <div className="flex flex-col justify-between h-screen w-56 bg-black text-white border-r border-zinc-800 px-4 py-6">
            {/* Top Section */}
            <div>
                <h1 className="text-3xl font-bold mb-12 bg-gradient-to-br 
                from-indigo-600 to-green-700 bg-clip-text text-transparent     tracking-wide select-none">
                    MonkX
                </h1>
                ...
                <nav className="flex flex-col gap-6">
                    {menuItems.map((item, idx) => (
                        <a
                            key={idx}
                            href="#"
                            className="flex items-center gap-3 group hover:text-green-400 transition-colors duration-200"
                        >
